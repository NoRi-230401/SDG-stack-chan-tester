...
// --------------------------------------
bool USE_SERVO_ST = true; // ** not use **
int SERVO_PIN_X = 13;
int SERVO_PIN_Y = 14;
...
// ------------------------------------------------------------------------
  ...
  */
  if (!servo_x.attach(SERVO_PIN_X, START_DEGREE_VALUE_X + servo_offset_x, DEFAULT_MICROSECONDS_FOR_0_DEGREE, DEFAULT_MICROSECONDS_FOR_180_DEGREE))
    Serial.println("Error attaching servo x");

  if (!servo_y.attach(SERVO_PIN_Y, START_DEGREE_VALUE_Y + servo_offset_y, DEFAULT_MICROSECONDS_FOR_0_DEGREE, DEFAULT_MICROSECONDS_FOR_180_DEGREE))
    Serial.println("Error attaching servo y");

  Serial.println("servo attach was done !!");
// ------------------------------------------------------------------------
...
void loop()
{
  ...
  {
    M5_LOGI("Not Support for copying this sketch to SD filesystem !!");
